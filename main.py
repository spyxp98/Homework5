...
def plot(filename):
   ...
   plt.scatter(epsilons[:10], data1, color = 'red', marker = 'o')
   plt.xscale('log')
   plt.scatter(epsilons[:10], data2, color = 'green', marker = '^')
   plt.xscale('log')
   plt.scatter(epsilons[:10], data3, color = 'blue', marker = 'v')
   plt.xscale('log')
